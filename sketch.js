...
var dog, dogImg;
var play, playImg;
var bee, beeImg, flipbeeImg;
var brick, brickImg;
var heart, heartImg;
var bee1, bee2, bee3, bee4, bee1a, bee2a, bee3a, bee4a;
...
function preload() {
  ...
  flipbeeImg = loadImage("images/flipbee.png");
...
function setup() {
  ...
  bee1.addImage(beeImg);
  bee1.scale = 0.08;
  bee1.velocityX = -7;
  bee1.velocityY = 0;

  bee1a = createSprite(160, 425, 10, 10);
  bee1a.addImage(flipbeeImg);
  bee1a.scale = 0.08;
  //bee1a.velocityX = 7;
  //bee1a.velocityY = 0;
  
  bee2 = createSprite(930, 100, 10, 10);//vertical
  bee2.addImage(beeImg);
  bee2.scale = 0.1;
  //bee2.velocityX = 0;
  //bee2.velocityY = 7;

  bee3 = createSprite(75, 80, 10, 10);//horizontal
  bee3.addImage(beeImg)
  bee3.scale = 0.1;

  bee4 = createSprite(930, 520, 10, 10);//horizontal
  bee4.addImage(beeImg);
  bee4.scale = 0.1;
...
function draw() {
  ...
  if (gameState === SERVE) {
    ...
    if (gameState === PLAY1){
      ...
      fill("darkblue");
      stroke("darkblue")
      text("You've got three lives! Avoid the beehives and bricks!", 250, 40);
